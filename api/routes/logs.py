...
async def get_log(
    ...
    data = {
        ...
        "detectionsAdded": log.detections_added,
        "detectionsRemoved": log.detections_removed,
    ...
    data = LogListData(
        list=[
            LogListItem(
                ...
                detectionsAdded=row.detections_added,
                detectionsRemoved=row.detections_removed,
